    ...
    return (
      <div className="price-calculator" id='price'>
        <div className='how-heading'> 
            ...
            <p>  Χρησιμοποιήστε τον Υπολογιστή τιμών STL μας για να λάβετε μια προσεγμένη εκτίμηση του κόστους για την εκτύπωση 3D του μοντέλου σας. Απλώς ανεβάστε το αρχείο .STL σας, επιλέξτε την τεχνολογία εκτύπωσης 3D (SLA ή FDM) και κάντε κλικ στο "Υπολογισμός" για να δείτε την τιμή.</p>
        </div>
